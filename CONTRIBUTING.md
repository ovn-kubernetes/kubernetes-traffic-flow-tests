...
Not everything happens through a GitHub pull request. Please come to the ovn-kubernetes
[meetings](./MEETINGS.md) or [Slack](https://cloud-native.slack.com/archives/C08452HR8V6) and let's discuss how we can work
together. We currently share the same meetings and slack channel as the ovn-kubernetes project.
...
for any contributor. [good first issue](https://github.com/ovn-kubernetes/kubernetes-traffic-flow-tests/labels/good%20first%20issue) has extra information to
help you make your first contribution. [help wanted](https://github.com/ovn-kubernetes/kubernetes-traffic-flow-tests/labels/help%20wanted) are issues
...
* be entirely in lowercase with the exception of proper nouns, acronyms, and
  ...
  * Add a wait for listen socket before any traffic test client connects
  * Add support for reverse config option
