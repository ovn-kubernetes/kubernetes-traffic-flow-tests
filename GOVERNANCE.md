...
The kubernetes-traffic-flow-tests & ovn-kubernetes and its leadership embrace the following values:
...
kubernetes-traffic-flow-tests Maintainers have write access to the [project GitHub repository](https://github.com/ovn-kubernetes/kubernetes-traffic-flow-tests).
...
are people who care about the ovn-kubernetes and kubernetes-traffic-flow-tests
project and want to help it grow and improve. A maintainer is not just someone
who can make changes, but someone who has demonstrated their ability to collaborate
...
- commitment to the project:
  ...
  - perform reviews for 4 non-trivial pull requests,
  - contribute 7 non-trivial pull requests and have them merged,
  - non-trivial pull requests can be bug fixes not just feature work
...
While most business in kubernetes-traffic-flow-tests is conducted by "[lazy consensus](https://community.apache.org/committers/lazyConsensus.html)",
